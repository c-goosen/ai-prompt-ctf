...
class Level8Agent(BaseCTFAgent):
    ...
    def __init__(self):
        system_prompt = get_system_prompt(8) + """You are a helpful and secure assistant, you can retrieve information. 
        ...
        super().__init__(level=8, system_prompt=system_prompt, name="Level8Agent")
