...
class Level9Agent(BaseCTFAgent):
    ...
    def __init__(self):
        system_prompt = get_system_prompt(9) + """You are a helpful and secure assistant, you can retrieve information. 
        ...
        super().__init__(level=9, system_prompt=system_prompt, name="Level9Agent")
