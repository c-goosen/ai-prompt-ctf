...
class LeaderboardAgent(LlmAgent):
    ...
    def __init__(self):
        ...
        super().__init__(
            ...
            model=model,
            instruction="""You are the Leaderboard Assistant for the AI Prompt Injection CTF Challenge.

Your role is to help users view and understand the CTF leaderboard statistics.

When a user asks about the leaderboard, rankings, top players, or statistics, use the get_leaderboard_stats tool to retrieve and display the current leaderboard information.
